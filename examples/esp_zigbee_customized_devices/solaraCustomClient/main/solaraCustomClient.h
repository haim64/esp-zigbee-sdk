...
#define CUSTOM_DEVICE_ID (0xFFF2)   // ZB_HA_CUSTOM_ATTR_DEVICE_ID
#define CUSTOM_CLUSTER_ID 0xff00
#define CUSTOM_COMMAND_REQ 0x0000

/* Basic manufacturer information */
#define ESP_MANUFACTURER_NAME "\x09""SOLARAINC"     /* Customized manufacturer name */
#define ESP_MODEL_IDENTIFIER "\x08""SOLCUSTC"       /* Customized model identifier */
