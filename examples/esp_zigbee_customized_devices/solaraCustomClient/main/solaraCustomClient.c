...
/*
        ...
        req.zcl_basic_cmd.dst_endpoint = on_off_light.endpoint;
        req.zcl_basic_cmd.src_endpoint = HA_ONOFF_SWITCH_ENDPOINT;
...
*/
        ...
        static uint32_t val = 0xA5;
        esp_zb_zcl_custom_cluster_cmd_req_t lsl_cmd_req;
        lsl_cmd_req.zcl_basic_cmd.dst_addr_u.addr_short = on_off_light.short_addr;
        lsl_cmd_req.zcl_basic_cmd.dst_endpoint = on_off_light.endpoint; // HA_ONOFF_SWITCH_ENDPOINT;
        lsl_cmd_req.zcl_basic_cmd.src_endpoint = HA_ONOFF_SWITCH_ENDPOINT;
        lsl_cmd_req.address_mode = ESP_ZB_APS_ADDR_MODE_16_ENDP_PRESENT;
        lsl_cmd_req.cluster_id = CUSTOM_CLUSTER_ID;
        lsl_cmd_req.profile_id = ESP_ZB_AF_HA_PROFILE_ID;
        lsl_cmd_req.direction = ESP_ZB_ZCL_CMD_DIRECTION_TO_SRV;
        lsl_cmd_req.data.value = &val;
        lsl_cmd_req.data.type = ESP_ZB_ZCL_ATTR_TYPE_U32;
        lsl_cmd_req.data.size = 1;
        lsl_cmd_req.custom_cmd_id = CUSTOM_COMMAND_REQ;
        esp_zb_lock_acquire(portMAX_DELAY);
        esp_zb_zcl_custom_cluster_cmd_req(&lsl_cmd_req);
        esp_zb_lock_release();
/*
        esp_zb_zcl_write_attr_cmd_t write_req;
        write_req.zcl_basic_cmd.dst_addr_u.addr_short = on_off_light.short_addr;
        write_req.zcl_basic_cmd.dst_endpoint = HA_ONOFF_SWITCH_ENDPOINT;
        write_req.zcl_basic_cmd.src_endpoint = HA_ONOFF_SWITCH_ENDPOINT;
        write_req.address_mode = ESP_ZB_APS_ADDR_MODE_16_ENDP_PRESENT;
        write_req.clusterID = CUSTOM_CLUSTER_ID;
        write_req.attributeID = 0;
        write_req.attrType = ESP_ZB_ZCL_ATTR_TYPE_U32;
        write_req.attrVal = (uint8_t *)&val;
...
/*
    ...
    esp_zb_custom_cluster_add_custom_attr(attributes_list, attr_id, attr_type, attr_access, attr_value);
*/
    ...
    esp_zb_cluster_list_add_custom_cluster(esp_zb_cluster_list, custom_cluster, ESP_ZB_ZCL_CLUSTER_CLIENT_ROLE);

    esp_zb_ep_list_t *esp_zb_ep_list = esp_zb_ep_list_create();
    esp_zb_endpoint_config_t endpoint_config = {
        .endpoint = HA_ONOFF_SWITCH_ENDPOINT,
        .app_profile_id = ESP_ZB_AF_HA_PROFILE_ID,
        .app_device_id = CUSTOM_DEVICE_ID, // ESP_ZB_HA_ON_OFF_SWITCH_DEVICE_ID,
